...
(define (another+ a b) ; iterative. There is no stack of recursivly connected functions here, each time we call new another+ func, but the parameters value controls the exit from iteration.
  (if (= a 0)
      b
      (another+ (dec a) (inc b))))